...
static const char *fonts[]          = { "JetBrainsMono Nerd Font:pixelsize=19:antialias=true:autohint=true, monospace:size=12" };
static const char dmenufont[]       = "JetBrainsMono Nerd Font:pixelsize=19:antialias=true:autohint=true, monospace:size=12";
//background color
